	...
	return (
		<header className="flex flex-col md:flex-row items-center justify-between bg-blue-500 p-4 md:p-5 text-white font-semibold gap-4 md:gap-x-10">
			...
			<div className="flex justify-between w-full items-center">
				<nav className="flex flex-row items-start md:items-center gap-3 md:gap-x-8 text-lg md:text-xl w-full md:w-auto">
					{token ? (
						<>
							<NavLink
								to="/"
				...
				{token && (
					<div className="flex flex-row items-center gap-3 md:gap-x-5 mt-2 md:mt-0">
						<span className="text-sm hidden md:block md:text-base truncate">
							{username}
						</span>
						<img
